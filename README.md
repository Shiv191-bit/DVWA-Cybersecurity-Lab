...
* **Screenshot:** ![SQL Injection](./TASK%201SQL%20INJECTION.png)
...
* **Screenshot:** ![CSRF](./TASK%203CSRF.png)
...
* **Screenshot:** ![Burp Intercept](./TASK%205%20A%20Burp%20Intercept%20&%20Modify.png)

### 6. Burp Suite Fuzzing (Task 5B)
* **Vulnerability:** Brute-force weakness.
* **Screenshot:** ![Burp Fuzzing](./Burp%20Intruder%20(Fuzzing)%205.png)

### 7. Security Headers (Task 6)
* **Analysis:** Missing critical HTTP security headers.
* **Screenshot:** ![Security Headers](./TASK%206%20SECURITY%20HEADER.png)
